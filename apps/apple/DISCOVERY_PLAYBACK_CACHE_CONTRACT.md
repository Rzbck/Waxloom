...
1. A track that is still legitimately reachable from the Watch UI or from an already-started Discovery queue must not become a server-side 404 merely because the background Discovery rotation advanced.
